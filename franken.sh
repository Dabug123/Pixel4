...
KERNEL="Image"
DTBIMAGE="dtb"
export CLANG_PATH=~/android/clangop/clang-r365631c/bin/
...
export LD_LIBRARY_PATH=${HOME}/android/clangop/clang-r365631c/lib64:$LD_LIBRARY_PATH
...
function make_dtb {
		$REPACK_DIR/tools/dtbToolCM -2 -o $REPACK_DIR/$DTBIMAGE -s 2048 -p scripts/dtc-aosp/ arch/arm64/boot/
}
